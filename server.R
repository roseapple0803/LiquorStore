    ...
    { 
      ...
      if (!is.null(thedf$Alcohol_Content)){
        ...
        ggplot(thedf, aes(Alcohol_Content))  +
          geom_histogram(fill="lightblue", colour ="slateblue4", binwidth=0.5) + 
...
#                  a new number of bins to be rendered.", "Hello", "World", sep="<br/><br/>"))
      ...
      list("This small Shiny application aims to help you get a quick glimpse of 
           your ", strong("product inventory"), ". It demonstrates Shiny's automatic UI updates.", br(),br(), 
          ...
          "Notice how all the related data are automatically re-evaluated and refreshed.",
           br(),br(),
           "Also click a tab such as ", strong("Plot"), "or ", strong("Tally"), "to view corresponding histogram 
          plot and data display change for your search criteria.")
